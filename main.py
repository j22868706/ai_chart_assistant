    ...
    async with httpx.AsyncClient(timeout=60.0) as client:
        try:
            ...
            reply_text = (
                ...
                f"⚠️ This content is automatically generated by AI and serves as a draft reference only. Please have it reviewed and confirmed by medical professionals before formal clinical use."
            )
